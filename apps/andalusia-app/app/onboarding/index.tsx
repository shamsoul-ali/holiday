...
const slides = [
  {
    id: '1',
    icon: 'moon' as const,
    title: 'Jemputan ke Tanah Suci',
    description: 'Pakej Umrah & Haji yang dipercayai sejak 22 tahun. Bersama Andalusia, perjalanan ibadah anda lebih tenang.',
    gradient: ['#059669', '#10B981'] as const,
  },
  {
    id: '2',
    icon: 'sparkles' as const,
    title: 'AI Ustaz Peribadi',
    description: 'Panduan umrah pintar, kursus interaktif, dan perancangan perjalanan berkuasa AI — semua di hujung jari anda.',
    gradient: ['#d97706', '#F59E0B'] as const,
  },
  {
    id: '3',
    icon: 'shield-checkmark' as const,
    title: 'Perjalanan Sempurna',
    description: 'Mutawif berpengalaman, visa terjamin, hotel berhampiran Haram, dan sokongan 24/7 sepanjang perjalanan.',
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={[styles.footer, { paddingBottom: insets.bottom + Spacing.lg }]}>
        ...
        <Button
          title={currentIndex === slides.length - 1 ? 'Mula Sekarang' : 'Seterusnya'}
          onPress={handleNext}
          size="lg"
          fullWidth
