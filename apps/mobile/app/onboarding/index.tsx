...
const slides = [
  {
    ...
    description: 'Get personalized travel itineraries crafted by AI in seconds. Budget-optimized, perfectly scheduled.',
    gradient: ['#059669', '#10B981'] as const,
  },
  {
    id: '2',
    icon: 'moon' as const,
    title: 'Halal-Friendly Everywhere',
    description: 'Prayer times, halal restaurants, and Muslim-friendly hotels — all built into every trip plan.',
  ...
  },
  {
    ...
    description: 'Secure payments with FPX, e-wallets & BNPL. Real-time pricing from 25+ travel providers.',
