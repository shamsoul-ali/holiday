...
const PRIMARY: NavItem[] = [
  ...
  { href: '/bayu/markets',         label: 'Source Markets',  icon: Users2 },
  { href: '/bayu/revenue',         label: 'Revenue',         icon: BarChart3 },
  { href: '/bayu/districts',       label: 'Districts',       icon: MapPin },
  { href: '/bayu/sustainability',  label: 'Sustainability',  icon: Leaf },
